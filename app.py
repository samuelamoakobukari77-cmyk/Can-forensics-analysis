...
from theme import inject_theme, animated_metric_row, threat_gauge, severity_line, pursuit_vehicle_banner, styled_recent_traffic
...
def main():
    ...
    with tabs[0]:
        ...
        with bcol:
            ...
            if counts.empty:
                ...
                for label, n in counts.items():
                    st.markdown(severity_line(label, n, total))
        ...
        st.dataframe(styled_recent_traffic(df, n=6), use_container_width=True)
